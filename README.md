...
Finished code can be found in the "Solution" folder.
Images of the Streamlit web application can be found at the bottom of this README file. 
...
![Images/.png](Images/pychain1.png)

![Images/.png](Images/pychain2.png)
